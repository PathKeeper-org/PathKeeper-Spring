...
import com.pathkeeper.backend.controller.safeZone.dto.SafeZoneResponse;
...
import com.pathkeeper.backend.domain.safeZone.service.SafeZoneService;
...
public class SafeZoneController {
    ...
    public ResponseEntity<SafeZoneResponse> createSafeZone(
        ...
        SafeZoneCreateInfo info = safeZoneService.generateAndSaveSafeZone(
                userDetails.getEmail(),
                SafeZoneCreateCommand.from(request)
        );

        return ResponseEntity.ok(SafeZoneResponse.from(info));
    }
    ...
    public ResponseEntity<SafeZoneResponse> findSafeZone(
        ...
        SafeZoneCreateInfo info = safeZoneService.findSafeZone(userDetails.getEmail());
