...
import com.pathkeeper.backend.domain.user.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<UserProfileResponse> findProfile(
        ...
        ProfileInfo info = userService.findProfile(userDetails.getEmail());

        return ResponseEntity.ok(UserProfileResponse.from(info));
    }
